...
import './About.css'; // Make sure your CSS is imported
    ...
    <div className="about-page-container">
      ...
      <div className="info-text">
        <p>
          ...
          the fastest method of producing a large number of seeds, we have not yet tested how the various extend algorithms perform using our 
          seeds; this is a clear area of future work, and suggestions are welcome. Despite the lack of an "extend" feature, BLANT is still 
